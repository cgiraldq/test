...
$rs = $conn->Execute("select * from galeria where activo=1 and id='".$_GET["id"]."' order by orden");
$rsgaleria = ($rs) ? $rs->GetRows() : array();
$imagen=explode(",",$rsgaleria[0]["imagen"]);
	...
	echo '<li class="span3 isotope-element isotope-filter1">
		<div class="thumb-isotope">
			<div class="thumbnail clearfix">
				<a href="./admin/archivos/'.$imagen[$i].'">
					<figure>
						<img src="./admin/archivos/'.$imagen[$i].'" alt="" width="200" ><em></em>
					</figure>
