...
<div class="breadcrumbs1_inner"><a href="index.php">Inicio</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;Galería Videos</div>	
</div>
</div>
</div>
...
$rs = $conn->Execute("select * from videos where activo=1 order by orden");
$rsvideos = ($rs) ? $rs->GetRows() : array();

for($i=0;$i<6;$i++){
	echo '<iframe width="30%" height="325" src="https://www.youtube.com/embed/'.$rsvideos[0]["video"].'?controls=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
}
