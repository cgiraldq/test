...
<div class="img"><img src="img/banner_quienes.jpg" alt=""></div>
<!--<img src="img/banner_quienes.jpg" alt="" class="grad2">-->
<div class="slider_bot">
<div class="page_title"></div>
<div class="breadcrumbs1">
<div class="breadcrumbs1_inner"><a href="index.php">Inicio</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;Quiénes somos</div>	
</div>
</div>
</div>
<?php
...
$rs = $conn->Execute("select * from paginas where pagina='quienes_somos'");
